...
export default function Page() {
  ...
  return (
    <div data-testid="admin-documents-page">
      <AdminPageHeader title="Documents" description="Administrative metadata view with privacy-safe fields." />
      <FilterBar>
        <FilterInput
          placeholder="Filter…"
          value={q}
        ...
        columns={[
          {
            ...
            render: (r: Record<string, unknown> & { id: string }) =>
              String(r.filename ?? r.safe_summary ?? r.filename ?? r.title ?? r.tool_name ?? "—"),
          },
          {
            key: "owner",
            header: "Owner / Actor",
